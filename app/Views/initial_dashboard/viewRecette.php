                                                ...
                                                <table class="table table-striped" id="table1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="compteur_final<?php echo $volucompteur->pompe_ids; ?>" onchange="volucompteur(<?php echo $volucompteur->pompe_ids; ?>)" name="compteur_final[]" value="<?php echo round($volucompteur->max_volucompteur_final,2); ?>" min="<?php echo $volucompteur->compteur_final; ?>" step="any" readonly></td>
                                                    ...
                                                    <?php if(isset($depense)){  
                                                            ...
                                                            <?php foreach ($depense as $d){ ?>                                                                
                                                                <tr id="<?php echo $compteur_depense; ?>">
                                                                    ...
                                                                    <td><input type="text" id=prix_depense<?php echo $compteur_depense; ?> value=<?php echo $d->produit_prix ; ?>></td>
...
$(document).ready(function() {
    ...
    $ca_volucompteur = parseFloat($ca_volucompteur).toFixed(2)
    $("#somme_ca").val(parseFloat($ca_volucompteur).toFixed(2))
    $("#total_volucompteur_header").html(parseFloat($ca_volucompteur).toFixed(2))
