...
$uri12 = service('uri')->getSegment(2);
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item <?= ($uri1 == 'volucompteurs') ? 'active' : '' ?> ">
                    <a href="/volucompteurs/<?php echo $uri12 ?>" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Volucompteurs</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item <?= ($uri1 == 'recettes') ? 'active' : '' ?> ">
                    <a href="/paiements/<?php echo $uri12 ?>" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Paiements</span>
                    </a>
                </li>
                <li class="sidebar-item <?= ($uri1 == 'services') ? 'active' : '' ?> ">
                    <a href="/services" class='sidebar-link'>
                        <i class="bi bi-grid-fill"></i>
                        <span>Ventes Services</span>
                    </a>
                </li>
                <li class="sidebar-item <?= ($uri1 == 'services') ? 'active' : '' ?> ">
                    <a href="/services" class='sidebar-link'>
